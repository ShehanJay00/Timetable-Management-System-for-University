...
public class ClassroomReportUser extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ClassroomReportUser
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CLASSROOM USAGE REPORT(Students)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClassroomReportUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClassroomReportUser().setVisible(true);
            }
        });
    }
